...
<p align="center"><sub><em>📸 <strong>截圖佔位</strong> — 設定 ▸ 外觀的色彩配色網格，每一格都是 app 的即時迷你預覽。</em></sub></p>
...
<p align="center"><sub><em>📸 <strong>截圖佔位</strong> — Install Helper 模組：分類的工具磚、安裝／更新按鈕，以及標題列的「全部更新」動作。</em></sub></p>
