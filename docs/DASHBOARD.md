...
| --- | --- | --- |
| `builtIn` | TypeScript component in `src/modules/dashboard/widgets/` registered in `builtInRegistry.ts` | Normal React render. Current built-ins are App Launcher, Connection, Notes, AI Coding Usage, Network Tools (subnet / DNS / speedtest tabs), and Generators (QR / cron / password / time / hash tabs). |
