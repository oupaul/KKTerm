...
- **Managed web UI affordances** are allowlisted per tool. Installed n8n exposes Run (`n8n start`) and Open web UI (`http://localhost:5678`) actions; arbitrary catalog commands are not accepted.
