...
| 15 | [15-settings.md](15-settings.md) | Every Settings section: General, Appearance, Dashboard, Installer Helper, Credentials, AI, SSH, Terminal, URL, RDP, VNC, About | `settings` |
...
| 18 | [18-installer.md](18-installer.md) | Installer Helper Module — Windows dev-tool catalog, install/update/uninstall, bundled catalog, UAC and WSL behaviour | `installer` |
