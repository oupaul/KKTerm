...
- Topics: Screenshots Module, screenshot library, capture region / window / fullscreen, thumbnails / details views, tray capture menu, global capture shortcuts, hotkeys, PNG / JPEG / WebP / GIF format, screenshots folder, rename / delete / copy screenshot, unified image viewer/editor, zoom, send to AI, copy to clipboard
