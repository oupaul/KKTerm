...
- `dashboard.backgroundModeDynamic` (`dashboard.backgroundDynamicHint`) — app-owned animated backgrounds: `aurora`, `clouds`, `ocean`, `raindrops`, `snow`, `sakura`, `fireflies`, `bubbles`, `ricefield`, `lanterns`, `starfield`, `nebula`, `embers`, `lava`, `matrix`, `topo`, `synthwave`, `cyberpunk`, `taipei101`, `thunderstorm`, `confetti`, `particleCursor` (keys under `dashboard.dynamicBackgrounds.*`).
