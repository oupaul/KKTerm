# itops.floorPlan.raiseTitle

- **English value**: `Raise`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/ServerRoomFloorPlan.tsx`
- **UI role**: `tooltip`
- **User flow**: Tooltip/aria-label on the control that moves a room object up to the next free vertical position in its floor cell.
- **Tone**: concise/neutral UI label
- **Placeholders**: none
- **Context/meaning**: Vertical position is measured in rack units (U) above the floor.
