...
- **English value**: `Click or type a label to copy. Ctrl-click or Shift-click a URL to open it. Esc to cancel.`
- **Namespace**: `terminal`
...
- **Placeholders**: none
- **Context/meaning**: "Label" means the two-letter hint shown next to each match. A normal click copies any match; Ctrl-click or Shift-click opens only URL matches. Ctrl, Esc, and Shift are keyboard keys and stay as-is.
