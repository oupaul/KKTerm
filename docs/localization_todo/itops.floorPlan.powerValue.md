# itops.floorPlan.powerValue

- **English value**: `{{used}} W / {{capacity}} W`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/ServerRoomFloorPlan.tsx`
- **UI role**: `status`
- **User flow**: Value line on a rack tile / 2.5D detail card in the power metric: summed device draw over the rack's configured capacity, in watts.
- **Tone**: concise/neutral
- **Placeholders**: {{used}}, {{capacity}} — both numbers in watts; keep the SI unit symbol W
