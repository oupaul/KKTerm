# itops.racks.serverRoomCreateHelp

- **English value**: `Server Rooms group racks inside a Site. Create the room with its first rack, then add more racks to the same room when needed.`
- **Namespace**: `itops`
...
<!--
Filename: itops.racks.serverRoomCreateHelp.md
