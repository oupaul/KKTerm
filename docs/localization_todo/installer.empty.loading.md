# installer.empty.loading

- **English value**: `Loading catalog…`
- **Namespace**: `installer`
- **File/component**: `src/modules/installer/InstallerPage.tsx`
- **UI role**: `status`
- **User flow**: Empty-state message shown while the remote catalog is being fetched and verified for the first time.
...
<!--
Filename: installer.empty.loading.md
