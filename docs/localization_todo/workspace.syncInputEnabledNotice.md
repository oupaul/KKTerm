# workspace.syncInputEnabledNotice
...
- **Domain notes**: "terminal" stays the locale's terminal term (e.g. zh-TW 終端機 / zh-CN 终端). Best-effort translations were added to every non-English locale; review before deleting this file.
