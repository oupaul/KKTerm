...
- **English value**: `Next prompt`
- **Namespace**: `terminal`
- **File/component**: `src/modules/workspace/connections/terminal/TerminalWorkspace.tsx`
- **UI role**: `button`
- **User flow**: Terminal Pane actions menu item that scrolls the scrollback to the next shell prompt (OSC 133 shell integration).
- **Tone**: concise/neutral
- **Placeholders**: none
- **Context/meaning**: "Prompt" is the shell command prompt line.
