# settings.fileExplorerOpenModeHint

- **English value**: `Choose whether File Explorer opens local files inside KKTerm or with the operating system's default app.`
- **Namespace**: `settings`
...
<!--
Filename: settings.fileExplorerOpenModeHint.md
