# itops.floorPlan.rotateViewLeft

- **English value**: `Rotate view left`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/ServerRoomIsoView.tsx`
- **UI role**: `tooltip`
- **User flow**: Tooltip/aria-label on the button that turns the 2.5D room one quarter turn counter-clockwise under the fixed camera.
- **Tone**: concise/neutral UI label
- **Placeholders**: none
- **Context/meaning**: Rotates the whole room view, not a rack.
