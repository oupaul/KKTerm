# installer.confirm.updateAllConfirm

- **English value**: `Update all`
- **Namespace**: `installer`
- **File/component**: `src/modules/installer/InstallerPage.tsx`
- **UI role**: `button`
- **User flow**: Primary button label inside the Update all confirm dialog.
- **Tone**: concise verb phrase
- **Placeholders**: none
...
<!--
Filename: installer.confirm.updateAllConfirm.md
