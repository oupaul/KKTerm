# itops.sites.dynamicFilterHint

- **English value**: `Resolved at run time — newly added Connections are picked up automatically.`
- **Namespace**: `itops`
...
<!--
Filename: itops.sites.dynamicFilterHint.md
