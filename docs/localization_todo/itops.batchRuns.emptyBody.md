# itops.batchRuns.emptyBody

- **English value**: `Send a script or an interactive playbook to every host in a Site at once, with per-host live output and a saved report.`
- **Namespace**: `itops`
...
<!--
Filename: itops.batchRuns.emptyBody.md
