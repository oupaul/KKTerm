# itops.sites.emptyBody

- **English value**: `A Site is a named selection of existing Connections used as the target for Batch Runs and Automations.`
- **Namespace**: `itops`
...
<!--
Filename: itops.sites.emptyBody.md
