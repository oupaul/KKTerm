# settings.terminalIntegrations

- **English value**: `Integrations`
- **Namespace**: `settings`
- **File/component**: `src/modules/settings/TerminalSettings.tsx`
- **UI role**: `heading`
- **User flow**: Fieldset legend in Settings → Terminal grouping inline images and terminal notification toggles.
