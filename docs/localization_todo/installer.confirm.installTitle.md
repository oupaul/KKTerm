# installer.confirm.installTitle

- **English value**: `Install {{name}}?`
- **Namespace**: `installer`
- **File/component**: `src/modules/installer/ToolRow.tsx`
- **UI role**: `heading`
- **User flow**: Title of the modal that confirms an install when prerequisites or UAC prompts are involved. {{name}} is the tool name.
...
<!--
Filename: installer.confirm.installTitle.md
