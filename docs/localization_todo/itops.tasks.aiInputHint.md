# itops.tasks.aiInputHint

- **English value**: `The previous node output is sent to the currently configured AI provider as untrusted data. AI nodes cannot run tools or generate executable actions.`
- **Namespace**: `itops`
