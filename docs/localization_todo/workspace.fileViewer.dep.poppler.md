# workspace.fileViewer.dep.poppler

- **English value**: `Poppler`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/viewers/PdfDependencyGate.tsx`
- **UI role**: `label`
- **User flow**: Display name of the Poppler PDF-rendering dependency.
...
<!--
Filename: workspace.fileViewer.dep.poppler.md
