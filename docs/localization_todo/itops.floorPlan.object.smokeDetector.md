# itops.floorPlan.object.smokeDetector

- **English value**: `Smoke detector`
- **Namespace**: `itops`
- **File/component**: `src/modules/itops/roomViewParts.tsx`
- **UI role**: `label`
- **User flow**: Room-object kind name: palette button, placement tooltip, and badge for a ceiling smoke detector.
- **Tone**: concise/neutral UI label
- **Placeholders**: none
- **Context/meaning**: Physical safety fixture.
