# installer.options.scopeUser

- **English value**: `Per-user`
- **Namespace**: `installer`
- **File/component**: `src/modules/installer/ToolRow.tsx`
- **UI role**: `label`
- **User flow**: Option in the scope selector for a per-user install (no UAC).
- **Tone**: concise label
- **Placeholders**: none
...
<!--
Filename: installer.options.scopeUser.md
