...
- **UI role**: `error`
- **User flow**: Status Bar error notice shown when the user clicks the refresh icon but the runtime cannot enumerate OS fonts (the Local Font Access API is unavailable).
