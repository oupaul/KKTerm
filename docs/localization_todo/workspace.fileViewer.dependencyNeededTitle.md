# workspace.fileViewer.dependencyNeededTitle

- **English value**: `Preview needs an add-on`
- **Namespace**: `workspace`
- **File/component**: `src/modules/workspace/connections/file-viewer/viewers/PdfDependencyGate.tsx`
- **UI role**: `heading`
- **User flow**: Heading of the gate shown when a file type needs a runtime-installed dependency.
...
<!--
Filename: workspace.fileViewer.dependencyNeededTitle.md
