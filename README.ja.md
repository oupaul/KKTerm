...
<p align="center"><sub><em>📸 <strong>スクリーンショット（仮）</strong> — 設定 ▸ 外観のカラースキームグリッド。各タイルはアプリのライブミニプレビュー。</em></sub></p>
...
<p align="center"><sub><em>📸 <strong>スクリーンショット（仮）</strong> — Install Helper モジュール：カテゴリー分けされたツールタイル、インストール／更新ボタン、ヘッダーの「すべて更新」アクション。</em></sub></p>
