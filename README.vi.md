...
<p align="center"><sub><em>📸 <strong>Ảnh chụp màn hình tạm</strong> — lưới bộ phối màu của Cài đặt ▸ Giao diện, mỗi ô là một bản xem trước thu nhỏ trực tiếp của ứng dụng.</em></sub></p>
...
<p align="center"><sub><em>📸 <strong>Ảnh chụp màn hình tạm</strong> — module Install Helper: các ô công cụ theo nhóm, nút cài/cập nhật, và hành động "Cập nhật tất cả" trên tiêu đề.</em></sub></p>
