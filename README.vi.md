...
- **Hai mươi sáu hình nền động** cho dashboard *và các terminal của bạn* (đúng vậy, có cả `matrix`), vì tụi mình cũng chẳng sĩ diện gì.
...
Chọn một tâm trạng — cho mỗi khung nhìn dashboard, *hoặc đặt sau bất kỳ terminal nào* — từ **hai mươi sáu** hình nền động trên canvas:
