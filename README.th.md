...
- **พื้นหลังเคลื่อนไหวยี่สิบหกแบบ** สำหรับแดชบอร์ด *และเทอร์มินัลของคุณ* (ใช่ รวมถึง `matrix` ด้วย) เพราะเราก็ไม่ได้สูงส่งเกินไป
...
เลือกอารมณ์ — ต่อมุมมองแดชบอร์ด *หรือไว้ด้านหลังเทอร์มินัลใดก็ได้* — จากพื้นหลังเคลื่อนไหวบน canvas **ยี่สิบหกแบบ**:
