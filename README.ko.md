...
<p align="center"><sub><em>📸 <strong>스크린샷 자리표시자</strong> — 설정 ▸ 모양의 컬러 스킴 그리드. 각 타일은 앱의 실시간 미니 미리보기.</em></sub></p>
...
<p align="center"><sub><em>📸 <strong>스크린샷 자리표시자</strong> — Install Helper 모듈: 분류된 도구 타일, 설치／업데이트 버튼, 헤더의 "모두 업데이트" 동작.</em></sub></p>
