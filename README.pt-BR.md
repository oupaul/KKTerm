...
| **Settings** | Geral, Aparência, Credenciais, IA, SSH, Terminal, URL, RDP, VNC, Dashboard, Installer Helper, Sobre; fontes de interface personalizadas; minimizar para bandeja; Don't Sleep; backup/importação |
