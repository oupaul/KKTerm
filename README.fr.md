...
| **Settings** | Général, Apparence, Identifiants, IA, SSH, Terminal, URL, RDP, VNC, Dashboard, Installer Helper, À propos ; polices UI personnalisées ; minimiser dans la barre système ; Don't Sleep ; sauvegarde/import |
