...
export const deepSeekProvider: AiProviderDefinition = {
  ...
  modelOptions: [
    { id: "deepseek-v4-flash", label: "DeepSeek V4 Flash", note: "Fast current model" },
    { id: "deepseek-v4-pro", label: "DeepSeek V4 Pro", note: "Most capable" },
    { id: "deepseek-chat", label: "DeepSeek Chat", note: "Legacy V4 Flash alias" },
    { id: "deepseek-reasoner", label: "DeepSeek Reasoner", note: "Legacy reasoning alias" },
  ],
